...
public class TypewriterMemoryy : MonoBehaviour
{
    ...
    private string fullText = "Welcome to the second level! Now the challenge gets a little more articulate. Solve the puzzle and take each piece as a piece of adventure ahead. Have fun, relax and immerse yourself in the beauty of this puzzle. Ready?";
